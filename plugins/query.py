...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://telegram.me/All_Movie_Request_groups")
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://github.com/sandippshah/PROFESSOR-BOT')
            ],[

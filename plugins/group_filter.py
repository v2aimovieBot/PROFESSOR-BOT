...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("🥴 यह किसी और के द्वारा की गई मूवी रिक्वेस्ट है। कृपया खुद से मूवी रिक्वेस्ट करें। 😎", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>👤𝐑𝐞𝐪𝐮𝐞𝐬𝐭𝐞𝐝 𝐛𝐲</b> : {message.from_user.mention}\n<b>🎬 𝐑𝐞𝐬𝐮𝐥𝐭𝐬 𝐟𝐨𝐫</b>: {search}\n_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳_̳\n<b>𝐉𝐨𝐢𝐧 𝐔𝐬 𝐎𝐧 👇</b>\n⚡@Pikashow_Movies_Request⚡\nMᴇssᴀɢᴇ Wɪʟʟ Bᴇ Aᴜᴛᴏ Dᴇʟᴇᴛᴇ ɪɴ 𝟸 Mɪɴᴜᴛᴇs Bᴇᴄᴀᴜsᴇ ᴏғ Cᴏᴘʏʀɪɢʜᴛ Issᴜᴇs"
...
async def advantage_spell_chok(msg):
    ...
    try:
        ...
        logger.exception(e)
        k = await msg.reply("I couldn't find any movie in that name. Check your spelling in Google then try again.")
        await asyncio.sleep(8)
        await k.delete()
        return
    movielist = []
    if not movies:
        k = await msg.reply("I couldn't find anything related to that. Check your spelling in Google then try again.")
        await asyncio.sleep(8)
        await k.delete()
        return        
    ...
    k = await msg.reply("CHECK YOUR MOVIE ON THE GIVEN LIST AND SELECT YOUR MOVIE..\nदी गई सूची में अपनी फिल्म देखें और अपनी फिल्म चुनें 👇👇",
                    reply_markup=InlineKeyboardMarkup(btn))
